...
exports.run = (client, message) => {
    var embed = new Discord.RichEmbed()
        ...
        .addField("Général", "``help`` • Affiche cet encart."
            ...
            + "\n[BIENTÔT !] ``ckey <valeur>`` • Crée une clé ayant la valeur en Blocs définie en argument."
            + "\n[BIENTÔT !] ``redeem <clé>`` • Utilise la clé spécifiée en argument afin de recevoir sa valeur en Blocs.")
        .addField("Premium", "[BIENTÔT !] ``nick <pseudonyme>`` • Change de pseudonyme, et ce, seulement sur Stradivarius !"
            + "\n[BIENTÔT !] ``say <message>`` • Fais parler Strad avec le message de ton choix !")
        .addField("Boutique", "[BIENTÔT !] ``shop`` • Ouvre la boutique du serveur.\n[BIENTÔT !] ``buy <numéro de l'article>`` "
